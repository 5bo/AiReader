 ...
 * 描述
 */
public class TranslationPage extends RelativeLayout {
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            TranslationPage.this.requestLayout();
        }

    };

    public TranslationPage(Context context, AttributeSet attrs, int defStyle) {
    ...
    public TranslationPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
